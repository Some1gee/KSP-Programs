...
def engineCalc(M0, M1, dVreq, M01, M11, constOfGrav, vac, maxEngineCount, reqVecRange, radialAsk):
  ...
  if vac == False:
    sLEngines = [("Spider", 260, 1.79, 0.02, 10, 0), ("Twitch", 275, 15, 0.08, 8, 0),("Thud", 275, 108.20, 0.9, 8, 0), ("Puff", 120, 9.60, 0.09, 6, 0), ("Ant", 80, 0.51, 0.02, 0, 1), ("Spark", 265, 16.56, 0.13, 3, 1), ("Terrier",85, 14.78, 0.50, 4, 1), ("Reliant",265,205.16, 1.25, 0, 1), ("Swivel", 250,167.97, 1.5, 3, 1), ("Vector", 295, 936.51, 4, 10.5, 1), ("Dart", 290, 153.53, 1, 0, 1), ("Nerv", 185, 13.88, 3, 0, 1), ("Poodle", 90, 64.29, 1.75, 4.5, 1), ("Skipper", 280, 568.75, 3, 2, 1), ("Mainsail", 285, 1379.03, 6, 2, 1), ("Twin Boar", 280, 1866.67, 10.5, 1.5, 1), ("Rhino", 205, 1205.88, 9, 4, 1), ("Mammoth",295, 3746.03, 15, 2, 1), ("Rapier", 275, 162.295, 2, 3, 1), ("Mastadon", 290, 1283.63, 5, 5, 1), ("Cheetah", 150, 52.82, 1, 4, 1), ("Bobcat", 290, 374.19, 2, 5, 1), ("Skiff", 265, 240.91, 1.6, 2, 1), ("Wolfhound", 70, 69.08, 3.3, 3, 1), ("Kodiak", 285, 247, 1.25, 0, 1), ("Cub", 280, 28.9, 0.18, 22.5, 0)]
